...
const Productpages = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/pengadaan/dev/v1/products/${page}/5`)
      .then((response) => {
  ...
  const handleOrderConfirmation = () => {
    ...
    if (storedOrderId) {
      ...
      axios
        .post(
          `http://localhost:8080/pengadaan/dev/v1/orders/${storedOrderId}/items`,
          orderItem
        )
        .then((response) => {
      ...
      axios
        .post("http://localhost:8080/pengadaan/dev/v1/orders", {})
        .then((response) => {
          console.log(response.data);
          ...
          axios
            .post(
              `http://localhost:8080/pengadaan/dev/v1/orders/${orderId}/items`,
              orderItem
            )
            .then((response) => {
              console.log(response.data);
